...
import "./Page2.css";   // note the correct file name

function Page2() {
  useEffect(() => {
    const els = document.querySelectorAll(".page2-animate-on-scroll");
  ...
  return (
    <div className="page2-wrapper">
      {/* NAV */}
      <nav className="page2-navbar">
        <div className="page2-nav-logo">ORTUS</div>

        <ul className="page2-nav-links">
          <li><a href="/">Home</a></li>
...
<section className="page2-hero">
  <img
    ...
    className="page2-hero-image"
  />
  <div className="page2-hero-overlay">
    {/* Left-side heading */}
    <p className="page2-subtitle-left">PROJECT NAME</p>

    {/* Bottom-right heading */}
    <h1 className="page2-booknow-right">BOOK NOW</h1>
  </div>
</section>
